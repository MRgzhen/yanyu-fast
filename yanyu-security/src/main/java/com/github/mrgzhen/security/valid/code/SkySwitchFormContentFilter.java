...
@Setter
@Slf4j
public class SkySwitchFormContentFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    public SkySwitchFormContentFilter(SwitchUserRequestMatcher switchUserRequestMatcher) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        if (!formParameters.isEmpty()) {
            HttpServletRequest wrapper = new SkySwitchFormContentFilter.FormContentRequestWrapper(request, formParameters);

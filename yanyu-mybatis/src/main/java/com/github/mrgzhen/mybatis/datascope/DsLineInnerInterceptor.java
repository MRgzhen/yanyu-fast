...
public class DsLineInnerInterceptor extends JsqlParserSupport implements InnerInterceptor {

    private GeneralDsHandler dsHandler;
    @Override
    public void beforeQuery(Executor executor, MappedStatement ms, Object parameter, RowBounds rowBounds, ResultHandler resultHandler, BoundSql boundSql) throws SQLException {
        if (dsHandler.ignoreMethod()) return;
    ...
    protected void processPlainSelect(PlainSelect plainSelect) {
        ...
        if (fromItem instanceof Table) {
            ...
            if (!dsHandler.ignoreTable(fromTable.getName())) {
                //#1186 github
    ...
    protected Expression builderExpression(Expression currentExpression, Table table) {
        ...
        equalsTo.setRightExpression(dsHandler.getDsDeptId());
    ...
    protected Column getAliasColumn(Table table) {
        ...
        column.append(dsHandler.getdsDeptColumn());
